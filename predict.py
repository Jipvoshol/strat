...
DEFAULT_TICKETS_PATH = "tickets_processed_predict.csv"
...
DEFAULT_MODELS_DIR = "models/" # Modellen worden verwacht in dezelfde map als het script
            ...
            if not event_specific_history.empty:
                ...
                if not event_specific_history.empty and 'first_event_date_start' in tickets.columns and pd.notna(tickets['first_event_date_start'].iloc[0]):
                    ...
                    if pd.notna(current_event_start_date):
                        ...
                        # CORRECT FIX: We want tickets sold UP TO AND INCLUDING the prediction moment (T_days_ago)
                        # This gives us cumulative sales at the time of prediction
...
def predict_tickets( 
    ...
    # De 'forecast_days' parameter voor engineer_features is de T van het geselecteerde model
